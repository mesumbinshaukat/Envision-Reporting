<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-2xl text-navy-900" style="padding-right: 15px !important;">Create Invoice</h2>
    </x-slot>
    ...
    <div class="max-w-2xl">
        ...
        <form method="POST" action="{{ route('invoices.store') }}" enctype="multipart/form-data" class="bg-white border border-navy-900 rounded-lg p-6 space-y-4">
            ...
            <div id="custom_payment_method_section" style="display: none;">
                ...
                <input type="text" name="custom_payment_method" id="custom_payment_method" value="{{ old('custom_payment_method') }}" class="w-full px-4 py-2 border border-navy-900 rounded" placeholder="Enter custom payment method" disabled>
            ...
            <div>
                ...
                <input type="number" name="payment_processing_fee" id="payment_processing_fee" value="{{ old('payment_processing_fee', 0) }}" step="0.01" min="0" class="w-full px-4 py-2 border border-navy-900 rounded" placeholder="0.00">
                <p class="text-xs text-gray-600 mt-1">Enter any payment processing fees (e.g., transaction fees)</p>
            </div>

            <!-- Attachments -->
            <div>
                <label for="attachments" class="block text-sm font-semibold text-navy-900 mb-1">Attachments (Payment Proof)</label>
